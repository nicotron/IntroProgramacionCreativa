...
function draw() {
    ...
    if (a > 1) { // uso de variable y operador aritmetico
        ...
        /*
        CONDICIONES ANIDADAS: Solo se ejecutaran una de estas condiciones
        SI la condicion anterior se cumple (es verdadera)
        por lo que para un estado de una condicion
        se puede escribir por lo menos una nueva condicion
        generando un nuevo NODO dentro de uno anterior
        */
        if ( b < 0) {
            print("estoy acá") // mensajes para comprobar correcta sintaxis
        } else {
            print("ESTOY ACA ") // mensajes para comprobar correcta sintaxis
